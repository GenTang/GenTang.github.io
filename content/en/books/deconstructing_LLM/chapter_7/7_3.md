...
![Figure 7-10 | 79%](./images/7-10.webp)

We now examine the key phenomenon of computational-graph expansion. Listing 7-6 contains two training observations, denoted $(x_1,y_1)$ and $(x_2,y_2)$. When these observations are passed into the model to calculate the loss, the graph expands as shown in Figure 7-11. The expansion factor is approximately proportional to the number of observations used. If the model is already complex and a large batch is processed at once, the resulting graph may become enormous—possibly exceeding the available hardware capacity and preventing execution.
...
![Figure 7-11 | 80%](./images/7-11.webp)
