...
Figure 13-6 shows the implementation of Figure 13-5 ([full code](https://github.com/GenTang/regression2chatgpt/blob/en/ch13_others/dt_logit.ipynb)). The process is straightforward, but the dummy-variable trap requires particular attention when a decision tree is used to extract features; see [Section 5.4.4](/books/deconstructing_LLM/chapter-5/5-4#section-5-4-4) for details.
...
![Figure 13-7 | 76%](./images/13-7.png)
