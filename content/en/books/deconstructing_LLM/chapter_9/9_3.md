...
#### Listing 9-6 Examples of Convolutional-Layer Parameter Settings ([Full Code](https://github.com/GenTang/regression2chatgpt/blob/en/ch09_cnn/res_nets.ipynb))
...
On this basis, we can implement a residual block containing two convolutional layers, as shown on the left of Figure 9-22 ([Full Code](https://github.com/GenTang/regression2chatgpt/blob/en/ch09_cnn/res_nets.ipynb)).
