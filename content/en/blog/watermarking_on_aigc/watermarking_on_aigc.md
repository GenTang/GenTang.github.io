...
>
> **Method:** Implement KGW from scratch and compare unwatermarked, moderately watermarked, and aggressively watermarked outputs from a DeepSeek model.
>
...
## Background: Anthropic Introduces Text Watermarking
...
For KGW, the usual null model treats green-list hits at different positions as approximately independent Bernoulli trials with a fixed success probability. If the green-list ratio is 25%, that probability is 0.25. Let a passage contain $n$ scored tokens, of which $x$ are green. Under this independence approximation, $x$ follows a binomial distribution, as illustrated in Figure 3. We can standardize the count using
...
Researchers are therefore exploring **non-distortionary watermarking techniques that preserve the model’s original output distribution**, often described informally as distortion-free or unbiased watermarks. This will be the subject of the [next article: **Google DeepMind SynthID-Text**](https://gentang.github.io/en/blog/watermarking_on_aigc_2/).
