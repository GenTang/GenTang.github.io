...
Researchers are therefore exploring watermarking techniques that **preserve the model’s original output distribution**, often described as distortion-free or unbiased watermarks. This will be the subject of the next article: **Google DeepMind SynthID-Text**.